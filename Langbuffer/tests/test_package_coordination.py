...
from langbuffer.package_coordination import acquire_playback, changing_packages
...
class PackageCoordinationChecks(unittest.TestCase):
    ...
    def test_other_process_cannot_change_packages_during_playback(self):
        ...
        try:
            self.assertEqual(self.child(
                'from langbuffer.package_coordination import changing_packages; '
                'import sys; '
    ...
    def test_dead_owner_does_not_leave_permanent_marker(self):
        self.child('from langbuffer.package_coordination import acquire_playback; '
