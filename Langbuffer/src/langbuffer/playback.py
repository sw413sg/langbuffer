...
from langbuffer.pipeline import AudioChunks, FrozenTimeline, LocalWorker, RATE, ROOT, WORK, model_path
from langbuffer.package_coordination import acquire_playback
...
from langbuffer.seekable_hls import PlaylistSource
from langbuffer.twitch_recovery import FORMAT_CHANGES, TwitchRecovery
from langbuffer import transport as transport
from langbuffer.transport import StreamBridge
from langbuffer.twitch_ads import TwitchPlaylistSource, TwitchAdTimeout
from langbuffer.extended_sources import resolve as resolve_extended, safe_error
from langbuffer.file_bridge import FileBridge, FileRelay
...
class LocalPlayback(QObject):
    ...
    def start(self, url, delay, *, device=None, caption_offset=0, quality=(0, 0), asr_model='base.en',
        ...
        from langbuffer.language_packages import LANGUAGES, effective_asr_model, required_packages, package_ready
        ...
        try:
            ...
            for event in events:
                ...
                if event.get('bundled_rejected'):
                    from langbuffer.language_packages import reject_bundled_package
