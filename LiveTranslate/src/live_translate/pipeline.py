...
def process_block(asr, translator, pcm, origin, cue_id, stop, report):
    ...
    from live_translate.readability import caption_pages
...
def recognize_translate(jobs, events, stop, generation, model_name='base.en',
    ...
    try:
        ...
        from live_translate.local_translation import LocalTranslation
        from live_translate.language_packages import bundled_package_rejected
        started = time.monotonic()
...
class LocalWorker:
    def __init__(self, generation, model_name='base.en', source_language='en', target_language='es'):
        from live_translate.language_packages import effective_asr_model, LANGUAGES
