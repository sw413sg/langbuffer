...
from live_translate.model_catalog import PINS, BUNDLED_OPUS_FILES
from live_translate.package_coordination import changing_packages, preparing_packages
...
def _download(url, destination, size, expected, algorithm, cancel, progress):
    ...
    request = urllib.request.Request(url, headers={'User-Agent': 'Mozilla/5.0 LiveTranslate/1.0'})
