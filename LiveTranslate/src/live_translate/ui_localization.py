...
Live Translate | Live Translate | Live Translate | Live Translate
Live Translate — settings | Live Translate — configuración | Live Translate — configurações | Live Translate — paramètres
...
Live Translate supports X broadcasts and Twitch/Kick channels. | Live Translate admite broadcasts de X y canales de Twitch/Kick. | Live Translate aceita transmissões do X e canais da Twitch/Kick. | Live Translate prend en charge les diffusions X et les chaînes Twitch/Kick.
...
This package is included with Live Translate and cannot be removed here. | Este paquete viene incluido con Live Translate y no se puede borrar aquí. | Este pacote está incluído no Live Translate e não pode ser removido aqui. | Ce pack est inclus dans Live Translate et ne peut pas être supprimé ici.
...
Included with Live Translate | Incluido con Live Translate | Incluído no Live Translate | Inclus dans Live Translate
