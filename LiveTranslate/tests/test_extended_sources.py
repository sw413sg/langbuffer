...
from live_translate.source_extension.contracts import Quality
from live_translate.source_extension.adapters import YouTubeLiveAdapter
from live_translate.source_extension.registry import normalize_url
from live_translate.extended_sources import resolve_metadata, runtime_options, safe_error, resolve
from live_translate.paired_hls import program_times, packed_timestamp, select_tracks
from live_translate.range_media import RangeSource
from live_translate.file_bridge import requested_range
...
class SourceTests(unittest.TestCase):
    ...
    def test_youtube_states_before_probe(self):
        for state in ('not_live', 'was_live', 'post_live', 'is_upcoming', None):
            with patch('live_translate.extended_sources.inspect_hls') as probe:
                with self.assertRaises(ValueError):
    ...
    def test_facebook_hls_requires_inspection(self):
        from live_translate.source_extension.contracts import Kind
        with patch('live_translate.extended_sources.inspect_hls',
    ...
    def test_remote_range_requires_206_and_resource_identity(self):
        ...
        with patch('live_translate.range_media.open_https', side_effect=responses):
